...
$(function () {
    ...
    $('#demo-marked').mobiscroll().eventcalendar({
        display: 'inline',
        marked: [
            { d: '5/1', color: '#ffc400' },
    ...
    $('#demo-colored').mobiscroll().eventcalendar({
        display: 'inline',
        colors: [
            ...
            { start: new Date(now.getFullYear(), now.getMonth() + 1, 15), end: new Date(now.getFullYear(), now.getMonth() + 1, 18), background: '#f4511e' }
        ]
    });

    $('#demo-labels').mobiscroll().eventcalendar({
        display: 'inline',
        labels: [
